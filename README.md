...
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **정현구** | 소프트웨어전공 | AI, 로봇, 임베디드, 게임, 창업, 요리, 스노우보드, 그림, 헬스 |
| **세짐** | 소프트웨어전공 | 인공지능, 알고리즘, 사이버보안, 음악 감상, 독서 |
| **고지민** | 소프트웨어전공 | AI, 게임개발, 웹, 스케이트, 헬스, OTT 시청 |
| **김유림** | 소프트웨어전공 | 알고리즘, 시스템 프로그래밍, 스타트업 |
